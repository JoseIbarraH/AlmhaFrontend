  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <div class="p-2 bg-indigo-500 dark:bg-indigo-900/30 rounded-lg">
    ...
    <div
      ...
      <div class="p-3 space-y-4">
        <div v-if="!modelValue.results_gallery || modelValue.results_gallery.length === 0"
          ...
          <LucideImage class="h-16 w-16 mx-auto mb-4 opacity-50" />
          <p class="text-sm font-medium">No hay imágenes en la galería</p>
...
import { LucideImage, LucideX, LucidePlus } from 'lucide-vue-next';
