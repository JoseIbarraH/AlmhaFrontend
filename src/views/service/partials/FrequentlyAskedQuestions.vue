  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            {{ modelValue.frequently_asked_questions?.length || 0 }}
            {{ modelValue.frequently_asked_questions?.length === 1 ? 'pregunta' : 'preguntas' }}
          </p>
        </div>
      </div>
      ...
      <button type="button" @click="addFrequentlyAskedQuestion"
        ...
        <span class="hidden sm:inline">Agregar pregunta</span>
      </button>
    </div>
    ...
    <div
      ...
      <div class="text-sm text-blue-800 dark:text-blue-300">
        <p class="font-medium mb-1">Consejos para buenas preguntas frecuentes:</p>
        <ul class="space-y-1 text-blue-700 dark:text-blue-400">
          <li>• Usa preguntas claras y directas</li>
          <li>• Proporciona respuestas concisas pero completas</li>
          <li>• Ordena las preguntas de más a menos frecuentes</li>
        </ul>
      </div>
    </div>
  </div>
