<template>
  ...
  <div
    class="w-full h-full bg-white rounded-2xl shadow-md border cursor-pointer flex items-center justify-center transition-all duration-300 p-4"
  ...
  >
    ...
    >
      ...
      />
      <path
        d="M490.667,42.667H21.333C9.551,42.667,0,52.218,0,64v384c0,11.782,9.551,21.333,21.333,21.333h469.333
        c11.782,0,21.333-9.551,21.333-21.333V64C512,52.218,502.449,42.667,490.667,42.667z M469.333,426.667H42.667V85.333h426.667
        V426.667z"
      />
      <path
        d="M91.582,377.752c8.331,8.331,21.839,8.331,30.17,0l91.582-91.582l48.915,48.915c8.331,8.331,21.839,8.331,30.17,0
