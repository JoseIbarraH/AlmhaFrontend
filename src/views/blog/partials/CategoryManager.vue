  ...
  <Modal :show="props.show" :max-width="props.maxWidth || 'lg'" @close="handleClose">
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
      ...
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Gestión de Categorías</h2>
      ...
      <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-700">
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">Nueva Categoría</h3>
        <div class="flex gap-2">
          <TextInput type="text" placeholder="Nombre de la categoría" v-model="form.title" />
      ...
      <div class="mb-6">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">Categorías Existentes</h3>
...
const saveEdit = async (id: number) => {
  ...
  try {
    await api.put(`/api/category/${id}`, { title: formEdit.titleEdit })
    emit('update')
    cancelEdit()
  } catch (error) {
